...
export const PLANS: Record<PlanId, PlanConfig> = {
  ...
  starter: { id: "starter", name: "Starter", nameAr: "ستارتر", description: "For freelancers and small projects", descriptionAr: "للمستقلين والمشاريع الصغيرة", priceMonthly: 19, priceYearly: 190, features: ["5 projects","Full brand strategy","3 corporate directions","Color palettes","Typography","Mood boards","Logo concepts","Brand Sheet"], featuresAr: ["5 مشاريع","استراتيجية علامة كاملة","3 اتجاهات مؤسسية","لوحات ألوان","نظام خطوط","Mood Boards","مفاهيم شعار","Brand Sheet"], stripePriceId: process.env.STRIPE_PRICE_STARTER ?? "", monthlyCredits: 100, maxProjects: 5, maxMembers: 1, maxShareLinks: 3, exportsAllowed: ["brand_sheet_pdf","color_palette_json","design_tokens_json"], watermark: false, clientPortal: false, brandBook: false, versionHistory: false, highResExports: false, designTokens: true },
