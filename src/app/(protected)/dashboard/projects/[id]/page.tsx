...
export default async function ProjectOverviewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const modules = [
    ...
    { href: `/dashboard/projects/${project.id}/directions`, icon: Layers, title: "الاتجاهات البصرية", description: "ثلاثة اتجاهات بصرية متمايزة", completed: project._count.visualDirections > 0, count: project._count.visualDirections },
    ...
    { href: `/dashboard/projects/${project.id}/logo`, icon: Sparkles, title: "مفاهيم الشعار", description: "أفكار الشعار ومعاينات بصرية", completed: project._count.logoConcepts > 0, count: project._count.logoConcepts },
